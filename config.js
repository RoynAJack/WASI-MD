...
//========================= [ BOT SETTINGS ] =========================\\
global.style = process.env.STYLE   || '1','2','3','4','5',  // put '1' to "5" here to check bot styles
...
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "null,false";
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "null,false";
...
module.exports = {
  ...
  ownername:process.env.OWNER_NAME|| "It's Mabhosiedu RoynJK😎👽",
